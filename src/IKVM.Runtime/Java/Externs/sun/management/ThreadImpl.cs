...
namespace IKVM.Java.Externs.sun.management
{
    ...
    static class ThreadImpl
    {

        public static object getThreads()
        {
            return IKVM.Java.Externs.java.lang.Thread.getThreads();
        }
        ...
        {
#if !FIRST_PASS
            System.Reflection.ConstructorInfo[] constructors = typeof(global::java.lang.management.ThreadInfo).GetConstructors(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic);
            foreach (System.Reflection.ConstructorInfo constructor in constructors)
            {
                if (constructor.GetParameters().Length == 9)
                {
                    global::java.lang.Thread[] threads = (global::java.lang.Thread[])getThreads();
                    global::java.lang.management.ThreadInfo[] threadInfos = (global::java.lang.management.ThreadInfo[])result;
                    for (int i = 0; i < ids.Length; i++)
                    {
                        ...
                        for (int t = 0; t < threads.Length; t++)
                        {
                            ...
                            {
                                global::java.lang.Thread thread = threads[t];

                                int state;
                                // invers to sun.misc.VM.toThreadState
                                switch (thread.getState().ordinal())
                                {
                                    case (int)global::java.lang.Thread.State.__Enum.RUNNABLE:
                                        state = JVMTI_THREAD_STATE_RUNNABLE;
                                        break;
                                    case (int)global::java.lang.Thread.State.__Enum.BLOCKED:
                                        state = JVMTI_THREAD_STATE_BLOCKED_ON_MONITOR_ENTER;
                                        break;
                                    case (int)global::java.lang.Thread.State.__Enum.WAITING:
                                        state = JVMTI_THREAD_STATE_WAITING_INDEFINITELY;
                                        break;
                                    case (int)global::java.lang.Thread.State.__Enum.TIMED_WAITING:
                                        state = JVMTI_THREAD_STATE_WAITING_WITH_TIMEOUT;
                                        break;
                                    case (int)global::java.lang.Thread.State.__Enum.TERMINATED:
                                        state = JVMTI_THREAD_STATE_TERMINATED;
                                        break;
                                    case (int)global::java.lang.Thread.State.__Enum.NEW:
                                ...
                                global::java.lang.StackTraceElement[] stacktrace = thread.getStackTrace();
                                if (maxDepth >= 0 && maxDepth < stacktrace.Length)
                                {
                                    global::java.lang.StackTraceElement[] temp = new global::java.lang.StackTraceElement[maxDepth];
                                ...
                                threadInfos[i] = (global::java.lang.management.ThreadInfo)constructor.Invoke(parameters);
                                break;
                            }
                        }
                    }
            ...
            throw new global::java.lang.InternalError("Constructor for java.lang.management.ThreadInfo not find.");
#endif
        }
